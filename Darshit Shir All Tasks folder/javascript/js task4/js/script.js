...
function output() {
  ...
  cell7.appendChild(p)
  cell8.innerHTML = `<div class="d-flex"><div><button type="button" class="button buttonEdit" style="--clr:#0000FF" onclick="editButton(${dataId})"><span>Edit</span><i></i></button></div>
  <div><button type="button" class="button buttonDelete ms-1" style="--clr:#FF0000" onclick="deleteButton(this)"><span>Delete</span><i></i></button></div></div>`

}

// edit button
function editButton(dataId) {
  alert("id" + dataId)
}
